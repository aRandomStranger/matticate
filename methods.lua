...
local function code2text(code)
	if code == 101 or code == 105 or code == 107 then
		return _('You need to make me an administrator of this group to allow me to kick people.')
	elseif code == 102 or code == 104 then
		return _('That user is an administrator, so I cannot kick them.')
	elseif code == 103 then
		return _('You don\'t need to unban users in a standard group.')
	elseif code == 106 then
		return _('The specified user isn\'t in this group.')
	elseif code == 7 then
		return false
	end
	return false
